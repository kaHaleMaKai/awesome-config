...
local function is_wibar_hidden()
    return awful.screen.focused().mywibox.visible
end
...
--awful.screen.connect_for_each_screen(function(s)
    ...
    local tagtable = tagtables[tag_index].tags
    local layout_table = tagtables[tag_index].layouts
